...
Example genome block annotation file for European samples are provided `./TIGAR/example_data/block_annotation_EUR.txt`. The genome block anotation files for other ethnicities can be adopted from the block segmentation generated by `LDetect`, https://bitbucket.org/nygcresearch/ldetect-data/src/master/.
