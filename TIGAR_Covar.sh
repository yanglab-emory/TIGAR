...
# genofile_path : Folders of genotype information (tabixed)
...
VARS=`getopt -o "" -a -l \
block:,genofile_path:,genofile_type:,chr:,Format:,maf:,thread:,out: \
-- "$@"`
...
do
    case "$1" in
        ...
        --genofile_path|-genofile_path) genofile_path=$2; shift 2;;
